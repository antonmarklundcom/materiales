...
return [
    ...
    'cuanto-hierro-lleva-una-columna' => [
        'keyword' => 'hierro para columnas planilla',
        'name'   => 'Hierro de una columna: quién lo define y cómo leer la planilla',
        'status' => 'activa',
        'published' => '2026-09-13',
        'updated'   => '2026-09-22',
        'order'  => 13,
        'title'  => 'Hierro para columnas en Paraguay: cómo leer la planilla',
