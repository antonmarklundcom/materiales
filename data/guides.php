...
return [
    ...
    'como-hacer-un-computo-metrico' => [
        ...
        'status' => 'activa',
        'order'  => 10,
        'title'  => 'Cómo hacer un cómputo métrico | Guía práctica',
    ...
    'como-elegir-un-corralon' => [
        ...
        'status' => 'activa',
        'order'  => 11,
        'title'  => 'Cómo elegir un corralón de materiales',
    ...
    'chapa-o-teja-que-techo-conviene' => [
        ...
        'status' => 'activa',
        'order'  => 12,
        'title'  => 'Chapa o teja: qué techo conviene',
    ...
    'cuanto-hierro-lleva-una-columna' => [
        ...
        'status' => 'activa',
        'order'  => 13,
        'title'  => 'Cuánto hierro lleva una columna | Guía práctica',
    ...
    'como-impermeabilizar-una-losa' => [
        ...
        'status' => 'activa',
        'order'  => 14,
        'title'  => 'Cómo impermeabilizar una losa | Paso a paso',
