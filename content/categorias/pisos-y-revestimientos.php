...
<p>
  Bajo "pisos y revestimientos" entran los materiales que cubren piso y pared en cualquier
  ambiente, cada uno con su función bien marcada. Para piso interior, el clásico es la
  <a href="/materiales/ceramica-para-piso/">cerámica para piso</a> (lo que casi todos piden
  simplemente como "cerámico"), y un escalón arriba en resistencia y terminación está el
  <a href="/materiales/porcelanato/">porcelanato</a>, la opción que se busca cuando se necesita
  una pieza más dura, más pareja y con menos absorción de agua. Para pared de baño y cocina
...
<p>
  Casi todo en esta categoría se vende por <strong>m² de piso</strong> o de pared, en
  <strong>caja cerrada</strong> según el formato de cada pieza, así que el pedido rara vez
  cierra en un número exacto de m²: hay que redondear a caja completa y sumar un margen por
  corte y desperdicio, sobre todo si el ambiente tiene ochavas o desniveles. Para cotizar bien,
  pasá la superficie a cubrir, el formato o tamaño de pieza que tenés en mente y si ya elegiste
  color o diseño, porque la disponibilidad de un mismo modelo puede variar entre lotes. La
...
<h2>Cómo elegir entre los distintos pisos y revestimientos</h2>
<p>
  La primera pregunta es si la pieza va en el piso o en la pared, y la segunda, cuánto tránsito
  y cuánta agua recibe. Con eso ya se descarta la mitad de las opciones:
</p>
<table>
  <thead>
  ...
  <tbody>
    <tr><td><a href="/materiales/ceramica-para-piso/">Cerámica para piso</a></td><td>Piso interior de toda la casa; en baño, un modelo apto para zonas húmedas</td><td>Formato, PEI según el tránsito y, si se moja, que sea antideslizante</td></tr>
    <tr><td><a href="/materiales/porcelanato/">Porcelanato</a></td><td>Living, cocina y ambientes de mucho paso</td><td>Pulido o mate, si es rectificado y el adhesivo reforzado</td></tr>
...
<p>
  Un ejemplo con la <a href="/calculadoras/ceramica-por-m2/">calculadora de cajas de cerámica
  y porcelanato</a>, para un baño de 2 × 2 m. El piso son 4 m²: con cajas de 1,44 m² (valor de
  ejemplo; el real figura en la caja) y colocación recta, 4 × 1,10 = 4,4 m², y 4,4 ÷ 1,44 =
  3,06, que sube a <strong>4 cajas</strong>, o sea 5,76 m² de cerámica para 4 m² de piso: en
  un ambiente chico, el redondeo a caja cerrada pesa más que el desperdicio. Si las paredes
  suman 15 m² de azulejo, con cajas de 1,5 m² salen 16,5 m² y <strong>11 cajas</strong>. Con un
  adhesivo de 5 kg/m² en bolsas de 25 kg (ejemplos: usá los de tu bolsa), son 1 bolsa para el
  piso y 3 para la pared.
</p>
