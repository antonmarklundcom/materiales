...
<p>
  ...
  suele pedir <strong>cemento de albañilería</strong>, que trae aditivos que lo hacen más trabajable que el
  cemento estructural puro. Cubre desde la base de un piso hasta la columna que sostiene el techo, así que
...
<p>
  Fijate que la bolsa esté bien cerrada y sin grumos al tacto: el cemento que tomó humedad pierde
  resistencia aunque parezca entero por fuera, y es un defecto que no se nota hasta que el hormigón ya
  fraguó mal. Revisá la fecha de fabricación si la bolsa la trae, porque el cemento guardado mucho tiempo
  en depósito rinde menos. Para estructura no reemplaces cemento gris por cemento de albañilería aunque
  salga más barato, porque no tiene la resistencia mecánica que pide una columna o una viga. Y si vas a
  usar cemento blanco para juntas o detalles vistos, guardalo aparte del cemento gris: basta un poco de
  polvo gris mezclado para que pierda el tono blanco parejo que buscás.
</p>

<p class="closing">
  Volvé a <a href="/materiales/cemento-y-cal/">cemento y cal</a> para ver el resto de la categoría, o
  mirá el <a href="/materiales/hormigon-elaborado/">hormigón elaborado</a> si preferís no mezclar en
