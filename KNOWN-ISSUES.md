...
27. **El sello anti-bot del formulario (`lead_form_stamp`) no tiene ventana de un solo uso.**
    ...
    **Actualización (2026-09-16): resuelto.** Se agregó throttling por IP con una ventana de
    60 segundos, compartida por compradores y proveedores. Anton eligió este enfoque en vez
